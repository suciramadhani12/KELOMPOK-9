...
<div class="d-none pt-5 px-4 print-show">
    <div class="row">
        <div class="col-12 text-center mb-2">
            <h1 style="font-size:60px;font-weight:700;"><?php echo $_SESSION[nama_toko] ?></h1>
            <h4 class="mb-0"><?php echo $_SESSION[alamat] ?></h4>
            <h4 class="mb-2">Tel : <?php echo $telp  ?></h4>
        </div>
        <div class="col-7">
            <h3 class="mb-0" style="text-transform: uppercase;">INVOICE : <?php echo $kodeCart ?></h3>
            <h3 class="mb-0" style="text-transform: uppercase;">KASIR : <?php echo $_SESSION[username] ?></h3>
        </div>
        <div class="col-5">
            <div class="row">
